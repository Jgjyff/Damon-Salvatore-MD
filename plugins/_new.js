let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `𝐷𝑎𝑚𝑜𝑛-𝑆𝑎𝑙𝑣𝑎𝑡𝑜𝑟𝑒-𝑀𝐷 𝐺𝑅𝑂𝑈𝑃𝐸 𝑆𝑈𝑃𝑃𝑂𝑅𝑇\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ 𝙶𝚁𝙾𝚄𝙿𝙴 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://chat.whatsapp.com/IdB2EfQiNlKBekQrigN9m9\n\n ${Config.botname} *©AKASHI-SASAKI*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `FOR ALL YOUR CONCERNS, JOIN Channel youtube TO FIND SOLUTIONS! \n\n *Channel youtube :* https://www.youtube.com/@SSK-FAMILYCAMPAGNY\n\n ${Config.botname} *©️AKASHI SASAKI*`;
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*𝐷𝑎𝑚𝑜𝑛-𝑆𝑎𝑙𝑣𝑎𝑡𝑜𝑟𝑒-𝑀𝐷 CURRENTLY ACTIVE BRO👻!*";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/AKASHI-SASAKI/Damon-Salvatore-MD*");
     }
 ...
 let tmpUrl = "https://telegra.ph/file/6e28b5b9cc330466b1f05.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
