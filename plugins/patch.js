  ...
  async (message, args) => {
    try {
      ...
      if (url.toLowerCase().includes("https")) {
        ...
        return await message.send("`Damon-Salvatore-MD- UPDATE WAS SUCCESSFULL ✅`");
      } else {
  ...
  async (_0x22514a) => {
    try {
      let _0x20ed34 = (
        ...
        "/" +
        formatp(os.totalmem()) +
        "\n\n *🧑‍💻 :*  ༒𝐷𝑎𝑚𝑜𝑛-𝑆𝑎𝑙𝑣𝑎𝑡𝑜𝑟𝑒-𝑀𝐷༒ ɪꜱ ɴᴏᴡ Aᴠᴀɪʟᴀʙʟᴇ\n\n" +
        readmore +
        "\n╭──❰𝐀𝐥𝐥 𝐌𝐞𝐧𝐮❱\n༆🏮 Lɪꜱᴛ\n༆🏮 Cᴀᴛᴇɢᴏʀʏ\n༆🏮 Hᴇʟᴘ\n༆🏮 Aʟɪᴠᴇ\n༆🏮 Uᴘᴛɪᴍᴇ\n༆🏮 Wᴇᴀᴛʜᴇʀ\n༆🏮 Lɪɴᴋ\n༆🏮 Cᴘᴜ\n༆🏮 Rᴇᴘᴏꜱɪᴛᴏʀʏ\n╰─────────────⦁"
      ).trim();
      ...
      const designs = [
        async () => {
          const imageBuffer = await axios.get(
            "https://telegra.ph/file/6e28b5b9cc330466b1f05.jpg",
            {
          ...
          const captionText = `𝐷𝑎𝑚𝑜𝑛-𝑆𝑎𝑙𝑣𝑎𝑡𝑜𝑟𝑒-𝑀𝐷\n\n*Ping:* ${pingSeconds} seconds${quoteText}\n\nDamon-Salvatore-MD`;

          return { image: imageBuffer.data, caption: captionText };
        },
        async () => {
          const imageBuffer = await axios.get(
            "https://telegra.ph/file/14da013d2b0b939484527.jpg",
            {
              responseType: "arraybuffer",
            }
          );
...
smd(
  ...
  async (m) => {
    try {
      ...
      const message = `*༒𝐷𝑎𝑚𝑜𝑛-𝑆𝑎𝑙𝑣𝑎𝑡𝑜𝑟𝑒-𝑀𝐷༒ ʀᴜɴɴɪɴɢ sɪɴᴄᴇ:* ${uptimeHours}h ${uptimeMinutes}ᴍ ${uptimeSeconds}s\n \t_ʜᴇʀᴇ's ᴍᴏʀᴇ ɪɴғᴏ_\n*ʀᴀᴍ ᴜsᴀɢᴇ:* ${ramUsage.toFixed(2)} MB\n*ᴄᴘᴜ ɴᴀᴍᴇ:* ${cpuModel}`;
      const contextInfo = {
        isForwarded: true,
        forwardingScore: 999,
        title: "༒𝐷𝑎𝑚𝑜𝑛-𝑆𝑎𝑙𝑣𝑎𝑡𝑜𝑟𝑒-𝑀𝐷༒ Running Since",
        body: message,
        footerText: "༒𝐷𝑎𝑚𝑜𝑛-𝑆𝑎𝑙𝑣𝑎𝑡𝑜𝑟𝑒-𝑀𝐷༒ 2024",
