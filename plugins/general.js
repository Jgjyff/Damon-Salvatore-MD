...
smd(
  {
    pattern: "repo",
    alias: ["git", "sc", "script", "Damon Salvatore"],
  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://github.com/AKASHI-SASAKI/Damon-Salvatore-MD"
      );
      let _0x1c73f9 = (
        "\nDamon-Salvatore-MD A simple Mutil Device WhatsApp Bot Created and Managed by KG TECH *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        (_0x44f98c?.stargazers_count || "None (🥲)") +
        " stars\n  *❲❒❳ Forks:* " +
        (_0x44f98c?.forks_count || "1000+") +
        " forks\n  *❲❒❳ Creator:* AKASHI-SASAKI\n  *❲❒❳ Created:* " +
  ...
  async (_0x397531) => {
    try {
      ...
      let _0x53eb40 = (
        " *I am " +
        Config.botname +
        "*\n  *❲❒❳ About:* A Simple WhatsApp Bot Created By AKASHI-SASAKI *" +
        Config.ownername +
        "*.\n\n  *❲❒❳ Speed:* " +
        latensie.toFixed(4) +
        " ms\n  *❲❒❳ Uptime:* " +
