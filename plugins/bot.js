    ...
    try {
      ...
      const designs = [
        ...
        async () => {
          ...
          const end = new Date().getTime();
          const pingSeconds = (end - start) / 1000;
          const captionText = `Damon-Salvatore-MD\n\n*ʀᴇsᴘᴏɴsᴇ ʀᴀᴛᴇ:* ${pingSeconds} seconds\n\n*Line:*\n${line.result}\n\nDamon-Salvatore-MD`;
...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By Damon-Salvatore-MD, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent 'Damon-Salvatore-MD' yet bro!*");
    }
    ...
    let _0x1b2187 = "*[Damon-Salvatore-MD Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
    ...
    _0x48b928.sendMessage(_0x48b928.from, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "Damon-Salvatore-MD Share list",
          sourceUrl: gurl
        }
      }
    }, {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent 'Damon-Salvatore-MD' yet bro!*");
    }
...
events.cmd({
  ...
  try {
    ...
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rent 'Damon-Salvatore-MD' yet!_*\n*_Can't disable cmds for shared users, If the bot is not shared!_*");
    }
...
const Rentt = async (_0x1b984f, _0x8bf7a7, _0x181a7a = "", _0x235024 = {}) => {
  ...
  async function _0x469083() {
    ...
    if (_0x235024.type === "session") {
      var _0xc4323e = ("" + _0x235024[_0x235024.type]).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/, "").replace(/Kerm;;;/gi, "").replace(/AKASHI-SASAKI ;;;/gi, "").replace(/DamonSalvatoreMD;;;/gi, "").replace(/^DamonSalvatore_\d{2}_\d{2}_\d{2}_\d{2}_/, "").trim();
      var _0x3358ad = {};
