...
smd({
  ...
  desc: "chat with an AI",
  category: "ai",
  use: "<Hii, AཽKཽAཽSཽHཽIཽ SཽAཽSཽAཽKཽIཽ>",
  filename: __filename,
  react: "📡"
  ...
  try {
    try {
      ...
      if (!_0x557719) {
        return man.reply("Provide me a query ex Who is Damon-Salvatore");
      }
...
smd({
  ...
  try {
    ...
    if (!_0x1b0897) {
      return _0x42b3b8.reply("Provide me a query ex Who is Damon-Salvatore-");
    }
...
smd({
  ...
  try {
    let {
      data: _0x44f98c
    } = await axios.get("https://api.github.com/repos/AKASHI-SASAKI/Damon-Salvatore-MD");
    let _0x1c73f9 = ("\n 𝐷𝑎𝑚𝑜𝑛-𝑆𝑎𝑙𝑣𝑎𝑡𝑜𝑟𝑒-𝑀𝐷 𝘈 𝘚𝘐𝘔𝘗𝘓𝘌 𝘞𝘏𝘈𝘛𝘚𝘈𝘗𝘗 𝘉𝘖𝘛 , 𝘔𝘈𝘋𝘌 𝘉𝘠 AཽKཽAཽSཽHཽIཽ SཽAཽSཽAཽKཽIཽ 𝘈𝘕𝘋 𝘋𝘌𝘗𝘓𝘖𝘠𝘌𝘋 𝘉𝘠 *" + Config.ownername + "*.\n\n  *❲❒❳ Stars:* " + (_0x44f98c?.stargazers_count || "120+") + " stars\n  *❲❒❳ Forks:* " + (_0x44f98c?.forks_count || "1000+") + " forks\n  *❲❒❳ Authors:* AKASHI-SASAKI\n  *❲❒❳ Created On:* " + (_0x44f98c?.created_at || "undefined") + "\n  *❲❒❳ Repo:* _https://github.com/AKASHI-SASAKI/Damon-Salvatore-MD_\n  *❲❒❳ Scan:* _" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
...
smd({
  ...
  use: "24206727xxxx,Your_text_here",
  fromMe: true,
  filename: __filename
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*Damon-Salvatore-MD • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("Damon-Salvatore-MD • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("QUEEN_ANITA-V2 • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
