const {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x1d2bb7) {
       return await _0x19564c.reply("*Provide Me Country Code. Example: .kik 242*");
     }
     ...
     for (let _0x723896 of _0x5f29e6) {
       ...
       if (_0x723896.id.startsWith(_0x35a368) && !_0x527887 && _0x723896.id !== _0x19564c.user && !_0x723896.id.startsWith("242067274660")) {
         if (!_0xff4f2e) {
           _0xff4f2e = true;
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x2ee3cb) {
       return await _0x4bd51e.reply("*Provide Me Country Code. Example: .num 242");
     }
 ...
 cmd({
   ...
   try {
     ...
     let _0x305de9 = {
       ...
       isForwarded: true,
       externalAdReply: {
         title: "Damon-Salvatore-MD Broadcast",
